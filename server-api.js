...
class Api {
    ...
    async getLastTracks(req, res) {
        try {
            var sql = "SELECT  activityName,  activityType,cast( ROUND(distance/1000) as int) AS distance, elevationGain, duration, startLatitude, startLongitude,startTime,filename from activities order by startTime DESC LIMIT 20";
